...
const MONGO_URI = "mongodb+srv://unnamed:unnamed@cluster0.a2qb56r.mongodb.net/?appName=Cluster0";
...
setInterval(() => {
    const fakeData = {
        ...
        voc: parseFloat((0.2 + (Math.random() * 0.8)).toFixed(2)),
        co2: Math.round(420 + (Math.random() * 200)),
        oxygen: parseFloat((20.9 - (Math.random() * 0.5)).toFixed(1))
    };
